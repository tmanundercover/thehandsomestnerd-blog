...
const NextSteps: FunctionComponent<StepProps> = ({lead, setLead}: StepProps) => {
      ...
      <Grid container alignItems="stretch" className={classes.root}>
        <Grid container direction="column" alignContent="center" className={classes.formContainer}>
          ...
          <Grid container direction="column" alignItems="center"
            ...
            <Grid container justify="center" item style={{position: "relative"}}>
              <motion.div
                initial={{
                  position:"relative",
                  left: -100,
              ...
              >
                <Typography
                  variant="h1"
                  color="textSecondary"
                  style={{textAlign: 'center', color: "#CEE4D1"}}
                  className={classes.responsiveTitle}>
                  Layers
                </Typography>
              </motion.div>
              ...
              <Typography
                variant="h1"
                color="textSecondary"
                style={{textAlign: 'center', color: "rgb(251, 124, 106)"}}
                className={classes.responsiveTitle}>
                Layers
              </Typography>
              </motion.div>
          ...
          <Grid container item>
            <Button
              ...
              style={{backgroundColor:"rgb(86, 81, 144)"}}
              classes={{disabled: classes.disabledButton}}
              className={classes.button}
              fullWidth={true}
              onClick={updateLead}
            >
              {!formSubmitting && <Typography variant="button" align="center">Reset</Typography>}
