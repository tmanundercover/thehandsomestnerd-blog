  ...
  return (
    <Grid container className={classes.root} alignItems="center">
      ...
      <Grid container direction="column" item xs={7}>
        <Grid container item direction="column" justify="space-around" className={classes.aboutMeSection}>
          <Grid container item>
          ...
          <Grid container item spacing={2}>
            {
              props?.specialties?.map(
                (specialty, index) =>
                  <Grid container key={index} item xs={6} alignItems="center">
                    <Check/>
                    <Typography className={classes.bulletedListItem}>
                      {specialty}
                    </Typography>
                  </Grid>
              )
          ...
          <Grid item>
            <Button variant="contained" color="primary" className={classes.resumeButton}><Typography variant="button"
                                                                                                     color="textSecondary">Download
