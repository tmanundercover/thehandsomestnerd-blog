                                        ...
                                        return <Grid item key={menuLink._type + index}>
                                            <Button href={menuItem.url ?? ""}
                                                    ...
                                                    style={{
                                                        ...
                                                        color: menuItem.isOutlinedButton || menuItem.isContainedButton ? TransformHWTheme.palette.primary.main : TransformHWTheme.palette.secondary.main
                                                    }}
                                        ...
                                        return <Grid item key={menuLink._type + index}>
                                            <Button
                                                ...
                                                style={{
                                                    ...
                                                    paddingRight:TransformHWTheme.spacing(2),
                                                    height: "100%",
